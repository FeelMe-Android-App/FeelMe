...
class UnfollowUserService(appContext: Context, workerParams: WorkerParameters): CoroutineWorker(appContext, workerParams),
    KoinComponent {
    ...
    override suspend fun doWork(): Result {
        ...
        return withContext(Dispatchers.IO) {
            when(val responseApi = userProfileRepository.unfollowUser(uid)) {
