...
object FeelMeDatabase {
    @Database(entities = [Movie::class, Genre::class, Stream::class, MovieGenreCrossRef::class, MovieStreamCrossRef::class, MovieNowPlaying::class, UserStreamList::class], version = 1)
    abstract class FeelMeRoomDatabase : RoomDatabase() {
        ...
        abstract fun userStream(): MyStreamServicesDao
    }
